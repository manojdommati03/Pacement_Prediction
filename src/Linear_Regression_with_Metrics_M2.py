...
DATASET_PATH =r"C:/Users/navya/OneDrive/Desktop/Machine L/Placement_prediction/dataset/final_preprocess_M2.csv"

OUTPUT_FOLDER ="C:/Users/navya/OneDrive/Desktop/Machine L/Placement_prediction/outputs/Linear_Regression_with_Metrics_M2"
...
# Convert +inf and -inf into NaN so that the imputer
# can handle them.
...
# The target value cannot be estimated using feature
# imputation, so rows with missing target values are removed.

target_missing = model_df[target_column].isnull().sum()

print(
    f"\nMissing target values: {target_missing}"
)
