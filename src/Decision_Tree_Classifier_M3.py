...
#
# IMPORTANT:
# 1. Original RAW dataset is NEVER modified.
# 2. StudentID is removed because it is only an identifier.
# 3. Salary Package is removed because it is normally an outcome
#    available after placement and can cause data leakage.
# 4. IsAnomaly is retained. Remove it if it was calculated using
#    PlacementStatus or any post-placement information.
#
# OUTPUTS:
#   1. Accuracy
#   2. Precision
...
OUTPUT_FOLDER = (
    r"C:/Users/navya/OneDrive/Desktop/Machine L/Placement_prediction/outputs/Decision_Tree_Classifier_M3_Outputs"
)
...
# ================================================================
# 15. REMOVE DATA LEAKAGE / IDENTIFIER FEATURES
# ================================================================

columns_to_remove = []

# StudentID is an identifier and should not be used for prediction.
...
# Salary Package is normally known after placement.
# Using it can cause target leakage.

if "Salary Package" in X.columns:
...
if len(columns_to_remove) > 0:
    ...
    print(
        "\nRemoving identifier / leakage-prone features:"
    )
...
# ================================================================
# 50. SAVE DECISION TREE PARAMETERS
# ================================================================
