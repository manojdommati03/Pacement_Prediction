...
OUTPUT = r"C:\Users\navya\OneDrive\Desktop\Machine L\Placement_prediction\outputs\EDA_Analysis_outputs"
...
for col in numeric_cols:
   ...
   plt.savefig(os.path.join(OUTPUT, "univariate_histogram.png"))
   plt.close()
   ...
   plt.savefig(os.path.join(OUTPUT, "boxplot.png"))
...
for col in numeric_cols:
   ...
   plt.savefig(os.path.join(OUTPUT, "outlier.png"))
...
summary.to_csv(os.path.join(OUTPUT, "Statistical_Summary.csv"))
...
corr.to_csv(os.path.join(OUTPUT, "Correlation_Matrix.csv"))
...
if len(numeric_df.columns) > 1:
   ...
   pair.savefig(os.path.join(OUTPUT,
                             "Pairplot.png"))
   plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT,"sctterplot.png"))
plt.close()
#
...
print("All figures are saved in:", OUTPUT)